...
struct CheckpointManager {
    ...
    // MARK: - record types
    struct RecordType {
        static let Checkpoint = "Checkpoints"
    }
    ...
    static func save(checkpoint: Checkpoint, completion: @escaping (Result<Checkpoint, Error>) -> ()) {
        let record = CKRecord(recordType: RecordType.Checkpoint)
    ...
    static func fetch(recordId: String, completion: @escaping (Result<Checkpoint, Error>) -> ()) {
        let pred = NSPredicate(format: "id == %@", recordId)
        let query = CKQuery(recordType: RecordType.Checkpoint, predicate: pred)
    ...
    static func delete(checkpoint: Checkpoint, completion: @escaping (Result<Checkpoint, Error>) -> ()) {
    ...
    static func modify(checkpoint: Checkpoint, completion: @escaping (Result<Checkpoint, Error>) -> ()) {
        let pred = NSPredicate(format: "id == %@", checkpoint.id)
        let query = CKQuery(recordType: RecordType.Checkpoint, predicate: pred)
    ...
    static private func sendSuccess(checkpoint: Checkpoint, completion: @escaping (Result<Checkpoint, Error>) -> ()) {
        DispatchQueue.main.async {
            completion(.success(checkpoint))
        }
    }
    
    static private func sendError(error: Error, completion: @escaping (Result<Checkpoint, Error>) -> ()) {
        DispatchQueue.main.async {
